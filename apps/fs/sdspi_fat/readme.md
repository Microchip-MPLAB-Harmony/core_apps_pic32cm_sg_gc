...
- Install the [micro-sd Click](https://www.mikroe.com/microsd-click) board on to the mikroBUS header of [PIC32CM GC00 Curiosity PRO]()
...
3. The LED is turned ON if there was no error during creating the directory and copying the file into it
    ...
    | ----- | -------- | ----------- |
    |  [PIC32CM GC00 Curiosity PRO]() | LED0 | SW0 |
    |||
